System.register(["PosApi/Consume/Dialogs", "PosApi/Entities", "PosApi/Extend/Triggers/PaymentTriggers", "PosApi/TypeExtensions", "../DataService/DataServiceRequests.g", "PosApi/Consume/Device"], function (exports_1, context_1) {
    "use strict";
    ...
    var Dialogs_1, Entities_1, Triggers, TypeExtensions_1, DataServiceRequests_g_1, Device_1, CheckBackDatePrePaymentTrigger;
    return {
        setters: [
        ...
        execute: function () {
            CheckBackDatePrePaymentTrigger = (function (_super) {
                __extends(CheckBackDatePrePaymentTrigger, _super);
                function CheckBackDatePrePaymentTrigger() {
                    return _super !== null && _super.apply(this, arguments) || this;
                }
                CheckBackDatePrePaymentTrigger.prototype.execute = function (options) {
                    return __awaiter(this, void 0, void 0, function () {
                        var localDeviceDateTime, statusCheckRequest, statusCheckResponse, cardResetDateTime, cardLastTransactionDate, stringYear, stringMonth, stringdate, stringHour, stringMinute, stringSecond, request, response;
                            ...
                            switch (_a.label) {
                                ...
                                case 1:
                                    ...
                                    if (statusCheckResponse.result == Entities_1.ClientEntities.ConnectionStatusType.Online) {
                                        ...
                                        if (!TypeExtensions_1.ObjectExtensions.isNullOrUndefined(options.cart) && !TypeExtensions_1.ObjectExtensions.isNullOrUndefined(options.cart.ExtensionProperties) && options.cart.ExtensionProperties.length > 0 && options.cart.ExtensionProperties.filter(function (a) { return a.Key == "CSDCardResetDateTime"; }).length > 0) {
                                            cardResetDateTime = options.cart.ExtensionProperties.filter(function (a) { return a.Key == "CSDCardResetDateTime"; })[0].Value.StringValue;
                                            cardLastTransactionDate = new Date();
                                            stringYear = cardResetDateTime.substr(0, 4);
                                            stringMonth = cardResetDateTime.substr(5, 2);
                                            stringdate = cardResetDateTime.substr(8, 2);
                                            stringHour = cardResetDateTime.substr(11, 2);
                                            stringMinute = cardResetDateTime.substr(14, 2);
                                            stringSecond = cardResetDateTime.substr(17, 2);
                ...
                CheckBackDatePrePaymentTrigger.prototype.showMessage = function (message, title) {
                ...
                return CheckBackDatePrePaymentTrigger;
            }(Triggers.PrePaymentTrigger));
            exports_1("default", CheckBackDatePrePaymentTrigger);
        }
    };
});
