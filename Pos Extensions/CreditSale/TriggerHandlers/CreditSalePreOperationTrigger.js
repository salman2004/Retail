System.register(["PosApi/Consume/Cart", "PosApi/Consume/Customer", "PosApi/Consume/Dialogs", "PosApi/Entities", "PosApi/Extend/Triggers/OperationTriggers"], function (exports_1, context_1) {
    ...
    return {
        ...
        execute: function () {
            CreditSalePreOperationTrigger = (function (_super) {
                __extends(CreditSalePreOperationTrigger, _super);
                function CreditSalePreOperationTrigger() {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    ...
                                    if (!(operationId === Entities_1.ProxyEntities.RetailOperation.PayCustomerAccount)) return [3 /*break*/, 5];
                                    cartRequest = new Cart_1.GetCurrentCartClientRequest();
                                    return [4 /*yield*/, this.context.runtime.executeAsync(cartRequest)];
                                case 1: return [4 /*yield*/, (_a.sent()).data];
                                case 2:
                                    cartResponse = _a.sent();
                                    customerRequest = new Customer_1.GetCustomerClientRequest(cartResponse.result.CustomerId);
                                ...
                                case 4:
                                    ...
                                    _a.label = 5;
                                case 5: return [2 /*return*/, Promise.resolve({ canceled: false })];
                            }
                        });
                    });
                };
                CreditSalePreOperationTrigger.prototype.showMessage = function (message, title) {
                ...
                return CreditSalePreOperationTrigger;
            }(Triggers.PreOperationTrigger));
            exports_1("default", CreditSalePreOperationTrigger);
        }
    };
});
