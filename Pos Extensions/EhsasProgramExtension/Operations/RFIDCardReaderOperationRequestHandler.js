System.register(["PosApi/Create/Operations", "./RFIDCardReaderOperationRequest", "PosApi/Consume/Cart", "PosApi/Entities", "PosApi/Consume/Peripherals", "PosApi/Consume/Dialogs", "../DataService/DataServiceRequests.g", "PosApi/Consume/Device"], function (exports_1, context_1) {
    "use strict";
    ...
    var Operations_1, RFIDCardReaderOperationRequest_1, Cart_1, Entities_1, Peripherals_1, Cart_2, Dialogs_1, DataServiceRequests_g_1, Device_1, RFIDCardReaderOperationRequestHandler;
    return {
        setters: [
            ...
            RFIDCardReaderOperationRequestHandler = (function (_super) {
                ...
                RFIDCardReaderOperationRequestHandler.prototype.executeAsync = function (request) {
                    return __awaiter(this, void 0, void 0, function () {
                        var statusCheckRequest, statusCheckResponse, hardwareStationDeviceActionRequest, response, stringResponse, obj, cartExtensionProperty, cartExtensionPropertylastTransactionDateTime, cartExtensionPropertyCardLimit, cartExtensionPropertyCardNumber, cartExtensionPropertyCardBalance, saveExtensionProperty, loyaltyCardRequest, subTitleMsg, numericInputDialogOptions, dialogRequest, result, res, csdCardNumber, writtenCardNumber, ActivateCardRequest, response_1;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                ...
                                case 3:
                                    ...
                                    if (!(obj.csdCardNumber != null || obj.csdCardNumber != "")) return [3 /*break*/, 17];
                                    ...
                                    if (!(obj.isCardActivated == true && obj.isCardBlocked == false)) return [3 /*break*/, 6];
                                ...
                                case 5:
                                    ...
                                    _a.label = 6;
                                case 6:
                                    if (!(obj.isCardActivated == false && obj.isCardBlocked == false)) return [3 /*break*/, 16];
                                    if (!(statusCheckResponse.result === Entities_1.ClientEntities.ConnectionStatusType.Online)) return [3 /*break*/, 15];
                                ...
                                case 9:
                                    res = _a.sent();
                                    if (!(res.result == true)) return [3 /*break*/, 11];
                                ...
                                case 15:
                                    this.showMessage("This Operation is not supported in offline mode.", "Error");
                                    _a.label = 16;
