System.register(["PosApi/Extend/Triggers/TransactionTriggers", "PosApi/TypeExtensions", "PosApi/Consume/Peripherals"], function (exports_1, context_1) {
    "use strict";
    ...
    var Triggers, TypeExtensions_1, Peripherals_1, CardReaderPostCartCheckoutTrigger;
    return {
        setters: [
            function (Triggers_1) {
                Triggers = Triggers_1;
        ...
        execute: function () {
            CardReaderPostCartCheckoutTrigger = (function (_super) {
                __extends(CardReaderPostCartCheckoutTrigger, _super);
                function CardReaderPostCartCheckoutTrigger() {
                    return _super !== null && _super.apply(this, arguments) || this;
                }
                CardReaderPostCartCheckoutTrigger.prototype.execute = function (options) {
                    return __awaiter(this, void 0, void 0, function () {
                        var properties, SampleCommerceProperties, cardReaderProperty, obj, isCardRebate, usedPoints, shopCode, csdCardNumber, WriteCardRequest, hardwareStationDeviceActionRequest;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    if (TypeExtensions_1.ObjectExtensions.isNullOrUndefined(options.salesOrder.ExtensionProperties) || options.cart.IsReturnByReceipt) {
                                    ...
                                    if (TypeExtensions_1.ObjectExtensions.isNullOrUndefined(cardReaderProperty) && cardReaderProperty == null || options.cart.LoyaltyCardId.length == 0) {
                                        return [2 /*return*/, Promise.resolve()];
                                    }
                ...
                CardReaderPostCartCheckoutTrigger.prototype.getPropertyValue = function (extensionProperties, column) {
                    extensionProperties = extensionProperties || [];
                    return extensionProperties.filter(function (prop) { return prop.Key === column; })
                        .map(function (prop) { return prop.Value; })[0];
                };
                return CardReaderPostCartCheckoutTrigger;
            }(Triggers.PostCartCheckoutTrigger));
            exports_1("default", CardReaderPostCartCheckoutTrigger);
        }
    };
});
